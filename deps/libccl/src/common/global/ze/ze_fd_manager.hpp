...
enum class ipc_mem_handle_type : int { regular, fabric };
static std::map<ipc_mem_handle_type, std::string> ipc_mem_handle_type_names = {
    std::make_pair(ipc_mem_handle_type::regular, "regular"),
    std::make_pair(ipc_mem_handle_type::fabric, "fabric"),
};
