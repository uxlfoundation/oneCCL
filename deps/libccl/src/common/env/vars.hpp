...
/**
 * @brief Set scatter algorithm
 *
 * @details
 * SCATTER algorithms
 *  - naive    Root sends one block per non-root rank; no staging buffers
 *
 * By-default: "naive"
 */
constexpr const char* CCL_SCATTER = "CCL_SCATTER";
...
constexpr const char* CCL_SCATTER_SCALEOUT = "CCL_SCATTER_SCALEOUT";
/** @} */
 ...
 */
/**
 * @brief Control synchronization of overlapping collectives.
 *
 * @details
 * 
 * Syntax
 * CCL_OP_SYCL_SERIALIZE="<value>"
 *
 * Arguments
 * "<value>"	Description
 * 	- 0	May use other sync mechanisms than serialization to main stream
 * 	- 1	All ops are synchronized to main stream that protects shared data
 *
 * Description
 * Set this variable to `1` to force serialization to main stream
 *
 * By-default: "0"
 */
constexpr const char* CCL_OP_SYCL_SERIALIZE = "CCL_OP_SYCL_SERIALIZE";
/** @} */
