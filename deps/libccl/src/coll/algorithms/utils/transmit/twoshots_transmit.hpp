...
// TwoShots transmit has a similar memory access pattern as OneShot.
// Please refer to oneshot_transmit.hpp for more details.
...
protected:
    ...
    // Effective reduction is the simple reduction op
    // performed in-flight by ProtoT::accumMessages
    // (custom reductions fall back to sum and are completed
    // separately via reduction_data / applyPreOpMessages).
