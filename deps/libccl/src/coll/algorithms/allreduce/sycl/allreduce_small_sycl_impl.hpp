...
#define TEMPLATE_ALLREDUCE_SMALL(DT) \
    template ccl::event allreduce_small_impl<DT>(const void *send_buf, \
                                                 void *recv_buf, \
                                                 size_t count, \
                                                 ccl::datatype dtype, \
                                                 ccl::reduction reduction, \
...
extern TEMPLATE_ALLREDUCE_SMALL(short);
extern TEMPLATE_ALLREDUCE_SMALL(int8_t);
extern TEMPLATE_ALLREDUCE_SMALL(uint8_t);
extern TEMPLATE_ALLREDUCE_SMALL(int);
extern TEMPLATE_ALLREDUCE_SMALL(uint32_t);
extern TEMPLATE_ALLREDUCE_SMALL(int64_t);
extern TEMPLATE_ALLREDUCE_SMALL(uint64_t);
extern TEMPLATE_ALLREDUCE_SMALL(float);
extern TEMPLATE_ALLREDUCE_SMALL(double);
#ifdef CCL_SYCL_VEC_SUPPORT_FP16
extern TEMPLATE_ALLREDUCE_SMALL(sycl::half);
#endif
#ifdef CCL_SYCL_VEC_SUPPORT_BF16
extern TEMPLATE_ALLREDUCE_SMALL(sycl::ext::oneapi::bfloat16);
#endif
