...
TEMPLATE_ALLREDUCE_LARGE(int8_t, true);
TEMPLATE_ALLREDUCE_LARGE(int8_t, false);
TEMPLATE_ALLREDUCE_LARGE_SU_RING(int8_t);
TEMPLATE_ALLREDUCE_LARGE_SU_RING_WRITE_NO_IPC(int8_t);
