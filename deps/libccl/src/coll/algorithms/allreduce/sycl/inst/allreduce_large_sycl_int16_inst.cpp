...
TEMPLATE_ALLREDUCE_LARGE(short, true);
TEMPLATE_ALLREDUCE_LARGE(short, false);
TEMPLATE_ALLREDUCE_LARGE_SU_RING(short);
TEMPLATE_ALLREDUCE_LARGE_SU_RING_WRITE_NO_IPC(short);
