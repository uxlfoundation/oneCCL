...
TEMPLATE_ALLREDUCE_LARGE(uint8_t, true);
TEMPLATE_ALLREDUCE_LARGE(uint8_t, false);
TEMPLATE_ALLREDUCE_LARGE_SU_RING(uint8_t);
TEMPLATE_ALLREDUCE_LARGE_SU_RING_WRITE_NO_IPC(uint8_t);
