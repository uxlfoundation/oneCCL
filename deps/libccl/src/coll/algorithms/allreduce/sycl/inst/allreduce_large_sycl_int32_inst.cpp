...
TEMPLATE_ALLREDUCE_LARGE(int, true);
TEMPLATE_ALLREDUCE_LARGE(int, false);
TEMPLATE_ALLREDUCE_LARGE_SU_RING(int);
TEMPLATE_ALLREDUCE_LARGE_SU_RING_WRITE_NO_IPC(int);
