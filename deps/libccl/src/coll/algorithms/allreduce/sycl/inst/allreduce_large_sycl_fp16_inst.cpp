...
TEMPLATE_ALLREDUCE_LARGE(sycl::half, true);
TEMPLATE_ALLREDUCE_LARGE(sycl::half, false);
TEMPLATE_ALLREDUCE_LARGE_SU_RING(sycl::half);
TEMPLATE_ALLREDUCE_LARGE_SU_RING_WRITE_NO_IPC(sycl::half);
#endif
