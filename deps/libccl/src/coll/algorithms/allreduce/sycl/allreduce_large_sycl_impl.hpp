...
#define TEMPLATE_ALLREDUCE_LARGE(DT, B) \
    template ccl::event allreduce_large_impl<DT, B>(const void *send_buf, \
                                                    void *recv_buf, \
                                                    size_t count, \
                                                    ccl::datatype dtype, \
                                                    ccl::reduction reduction, \
...
extern TEMPLATE_ALLREDUCE_LARGE(short, true);
extern TEMPLATE_ALLREDUCE_LARGE(short, false);
extern TEMPLATE_ALLREDUCE_LARGE(int8_t, true);
extern TEMPLATE_ALLREDUCE_LARGE(int8_t, false);
extern TEMPLATE_ALLREDUCE_LARGE(uint8_t, true);
extern TEMPLATE_ALLREDUCE_LARGE(uint8_t, false);
extern TEMPLATE_ALLREDUCE_LARGE(int, true);
extern TEMPLATE_ALLREDUCE_LARGE(int, false);
extern TEMPLATE_ALLREDUCE_LARGE(uint32_t, true);
extern TEMPLATE_ALLREDUCE_LARGE(uint32_t, false);
extern TEMPLATE_ALLREDUCE_LARGE(int64_t, true);
extern TEMPLATE_ALLREDUCE_LARGE(int64_t, false);
extern TEMPLATE_ALLREDUCE_LARGE(uint64_t, true);
extern TEMPLATE_ALLREDUCE_LARGE(uint64_t, false);
extern TEMPLATE_ALLREDUCE_LARGE(float, true);
extern TEMPLATE_ALLREDUCE_LARGE(float, false);
extern TEMPLATE_ALLREDUCE_LARGE(double, true);
extern TEMPLATE_ALLREDUCE_LARGE(double, false);
#ifdef CCL_SYCL_VEC_SUPPORT_FP16
extern TEMPLATE_ALLREDUCE_LARGE(sycl::half, true);
extern TEMPLATE_ALLREDUCE_LARGE(sycl::half, false);
#endif
#ifdef CCL_SYCL_VEC_SUPPORT_BF16
extern TEMPLATE_ALLREDUCE_LARGE(sycl::ext::oneapi::bfloat16, true);
extern TEMPLATE_ALLREDUCE_LARGE(sycl::ext::oneapi::bfloat16, false);
#endif
