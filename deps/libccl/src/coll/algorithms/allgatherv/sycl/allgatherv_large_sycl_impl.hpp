...
#define TEMPLATE_ALLGATHERV_LARGE(DT, B) \
    template ccl::event allgatherv_large_impl<DT, B>(sycl::queue & q, \
                                                     const void* send_buf, \
                                                     size_t send_count, \
                                                     void* recv_buf, \
                                                     const ccl::vector_class<size_t>& recv_counts, \
...
extern TEMPLATE_ALLGATHERV_LARGE(short, true);
extern TEMPLATE_ALLGATHERV_LARGE(short, false);
extern TEMPLATE_ALLGATHERV_LARGE(int8_t, true);
extern TEMPLATE_ALLGATHERV_LARGE(int8_t, false);
extern TEMPLATE_ALLGATHERV_LARGE(uint8_t, true);
extern TEMPLATE_ALLGATHERV_LARGE(uint8_t, false);
extern TEMPLATE_ALLGATHERV_LARGE(int, true);
extern TEMPLATE_ALLGATHERV_LARGE(int, false);
extern TEMPLATE_ALLGATHERV_LARGE(uint32_t, true);
extern TEMPLATE_ALLGATHERV_LARGE(uint32_t, false);
extern TEMPLATE_ALLGATHERV_LARGE(int64_t, true);
extern TEMPLATE_ALLGATHERV_LARGE(int64_t, false);
extern TEMPLATE_ALLGATHERV_LARGE(uint64_t, true);
extern TEMPLATE_ALLGATHERV_LARGE(uint64_t, false);
extern TEMPLATE_ALLGATHERV_LARGE(float, true);
extern TEMPLATE_ALLGATHERV_LARGE(float, false);
extern TEMPLATE_ALLGATHERV_LARGE(double, true);
extern TEMPLATE_ALLGATHERV_LARGE(double, false);
#ifdef CCL_SYCL_VEC_SUPPORT_FP16
extern TEMPLATE_ALLGATHERV_LARGE(sycl::half, true);
extern TEMPLATE_ALLGATHERV_LARGE(sycl::half, false);
#endif
#ifdef CCL_SYCL_VEC_SUPPORT_BF16
extern TEMPLATE_ALLGATHERV_LARGE(sycl::ext::oneapi::bfloat16, true);
extern TEMPLATE_ALLGATHERV_LARGE(sycl::ext::oneapi::bfloat16, false);
#endif
