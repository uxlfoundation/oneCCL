...
#define TEMPLATE_ALLGATHERV_SMALL(DT) \
    template ccl::event allgatherv_small_impl<DT>(sycl::queue & q, \
                                                  const void* send_buf, \
                                                  size_t send_count, \
                                                  void* recv_buf, \
                                                  const ccl::vector_class<size_t>& recv_counts, \
...
extern TEMPLATE_ALLGATHERV_SMALL(short);
extern TEMPLATE_ALLGATHERV_SMALL(int8_t);
extern TEMPLATE_ALLGATHERV_SMALL(uint8_t);
extern TEMPLATE_ALLGATHERV_SMALL(int);
extern TEMPLATE_ALLGATHERV_SMALL(uint32_t);
extern TEMPLATE_ALLGATHERV_SMALL(int64_t);
extern TEMPLATE_ALLGATHERV_SMALL(uint64_t);
extern TEMPLATE_ALLGATHERV_SMALL(float);
extern TEMPLATE_ALLGATHERV_SMALL(double);
#ifdef CCL_SYCL_VEC_SUPPORT_FP16
extern TEMPLATE_ALLGATHERV_SMALL(sycl::half);
#endif
#ifdef CCL_SYCL_VEC_SUPPORT_BF16
extern TEMPLATE_ALLGATHERV_SMALL(sycl::ext::oneapi::bfloat16);
#endif
