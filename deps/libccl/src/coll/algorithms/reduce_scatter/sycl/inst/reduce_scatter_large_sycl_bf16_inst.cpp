...
TEMPLATE_REDUCE_SCATTER_LARGE(sycl::ext::oneapi::bfloat16, true);
TEMPLATE_REDUCE_SCATTER_LARGE(sycl::ext::oneapi::bfloat16, false);
TEMPLATE_REDUCE_SCATTER_LARGE_SU_RING(sycl::ext::oneapi::bfloat16);
#endif
