...
#define TEMPLATE_REDUCE_SCATTER_SMALL(DT) \
    template ccl::event reduce_scatter_small_impl<DT>(const void* send_buf, \
                                                      void* recv_buf, \
                                                      size_t recv_count, \
                                                      size_t rem_count, \
                                                      ccl::datatype dtype, \
...
extern TEMPLATE_REDUCE_SCATTER_SMALL(short);
extern TEMPLATE_REDUCE_SCATTER_SMALL(int8_t);
extern TEMPLATE_REDUCE_SCATTER_SMALL(uint8_t);
extern TEMPLATE_REDUCE_SCATTER_SMALL(int);
extern TEMPLATE_REDUCE_SCATTER_SMALL(uint32_t);
extern TEMPLATE_REDUCE_SCATTER_SMALL(int64_t);
extern TEMPLATE_REDUCE_SCATTER_SMALL(uint64_t);
extern TEMPLATE_REDUCE_SCATTER_SMALL(float);
extern TEMPLATE_REDUCE_SCATTER_SMALL(double);
#ifdef CCL_SYCL_VEC_SUPPORT_FP16
extern TEMPLATE_REDUCE_SCATTER_SMALL(sycl::half);
#endif
#ifdef CCL_SYCL_VEC_SUPPORT_BF16
extern TEMPLATE_REDUCE_SCATTER_SMALL(sycl::ext::oneapi::bfloat16);
#endif
