...
struct sycl_allgather_coll : sycl_base_coll<Dtype, allgather_strategy_impl> {
    using coll_base = sycl_base_coll<Dtype, allgather_strategy_impl>;
    using coll_base::send_bufs;
    using coll_base::recv_bufs;
    using coll_base::host_send_buf;
    using coll_base::host_recv_buf;

    sycl_allgather_coll(bench_init_attr init_attr) : coll_base(init_attr) {}
