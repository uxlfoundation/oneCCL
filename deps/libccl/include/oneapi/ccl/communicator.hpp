...
public:
    ...
    /**
     * Flushes all outstanding communication operations on this communicator.
     * Waits for all collective operations from all streams associated with this communicator to complete.
     */
    void finalize();
