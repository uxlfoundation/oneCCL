...
function(define_compute_backend)
    if (NOT DEFINED COMPUTE_BACKEND)
        ...
        # Check if compiler supports -fsycl flag to auto-detect SYCL capability
        include(CheckCXXCompilerFlag)
        check_cxx_compiler_flag("-fsycl" COMPILER_SUPPORTS_FSYCL_AUTO)
        if (COMPILER_SUPPORTS_FSYCL_AUTO)
            set(COMPUTE_BACKEND "dpcpp" CACHE STRING "compute backend value")
            message(STATUS "COMPUTE_BACKEND: ${COMPUTE_BACKEND} (auto-detected via -fsycl support)")
        endif()
    else()
