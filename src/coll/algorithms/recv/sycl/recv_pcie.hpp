...
struct Recv : public Transmit<T, Proto, SubGroupSize> {
    ...
    sycl::nd_range<1> getLaunchParam(sycl::queue q,
        ...
        auto newSeqNo =
            comm->increase_rt_pattern(pattern_type::recv, peer_rank, updateSeqNo, nSteps);
    ...
    void operator() [[sycl::reqd_sub_group_size(SubGroupSize)]] (sycl::nd_item<1> pos) const {
        ...
        const_cast<Recv*>(this)->runRecvStart(my_rank, peer_rank);
...
#endif
            const_cast<Recv*>(this)->runRecv(wireOff, tOff, workLeft, my_rank, peer_rank);
        }
    }
