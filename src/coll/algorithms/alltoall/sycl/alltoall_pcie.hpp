...
template <typename T,
          ...
          class Transmit,
          int SubGroupSize = 16>
struct AllToAll : public Transmit<T, Proto, SubGroupSize> {
    ...
    static sycl::event launch(int nranks,
        ...
        sycl::event e;
        AllToAll offload(
            nranks, input, output, offsets, nelems, rank, step, ipcbuf0, ipcbuf1, peerbuf, p2p);
...
#endif
            const_cast<AllToAll*>(this)->runAllToAll(wireOff, tOff, workLeft);
        }
    }
