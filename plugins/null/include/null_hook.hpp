...
typedef enum onecclHookPoint {
    ...
    ONECCL_AFTER_MEM_ALLOC,
    ONECCL_BEFORE_MEM_FREE,
    ONECCL_AFTER_MEM_FREE,
    ONECCL_BEFORE_COMM_REGISTER,
    ONECCL_AFTER_COMM_REGISTER,
    ONECCL_BEFORE_COMM_DEREGISTER,
    ONECCL_AFTER_COMM_DEREGISTER,
    ONECCL_BEFORE_COMM_WINDOW_REGISTER,
    ONECCL_AFTER_COMM_WINDOW_REGISTER,
    ONECCL_BEFORE_COMM_WINDOW_DEREGISTER,
    ONECCL_AFTER_COMM_WINDOW_DEREGISTER,
